...
return (
    <Flex w='90%' m='auto' pt={20} justifyContent='space-between'> 
      ...
      <Box w='50%'>
        ...
        <Text>The Velvet Box is one of the leading exclusively designed jewellery showroom, focusing giving you an awsome jewellery buying experience. We strive to provide you with possibly the largest collection of curated designs for every occasion. We are grateful to be trusted by a number of happy customers.</Text>
      </Box>
    </Flex>
  )
}
