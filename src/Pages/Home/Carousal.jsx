...
return (
      <Box p={5} pt={20}  textAlign={"center"}>
        ...
        <hr />
        <Text w='40%' m='auto'>Exquisite jewels, crafted with precision, sparkle with elegance, embodying timeless beauty and unparalleled craftsmanship, destined to enchant admirers forever.</Text>
